...
func TestProjectHTTPSURLUsesConfiguredRouterPort(t *testing.T) {
	...
	if got := ProjectHTTPSURL("devoidofbeauty.com"); got != "https://devoidofbeauty.com.porto.local:37681/" {
		t.Fatalf("URL = %q", got)
	}

	t.Setenv(RouterTLSAddrEnv, "127.0.0.1:443")
	if got := ProjectHTTPSURL("devoidofbeauty.com"); got != "https://devoidofbeauty.com.porto.local/" {
